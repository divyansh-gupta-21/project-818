    ...
    function SideBar(){
        ...
        <div className="min-h-screen bg-white dark:bg-black border-r border-gray-200 sm:w-full dark:border-gray-900" style={{"width": "300px"}}>
            ...
            <div className="w-full h-auto px-4 py-3 bg-white dark:bg-black">
                ...
                <ul className="m-0">
                    <li onClick={() => setActiveTab("general")} className={activeTab == "general" ? "cursor-pointer hover:bg-gray-100 bg-gray-100 dark:bg-"+themeColor+"-500 dark:hover:bg-"+themeColor+"-700 rounded-lg dark:text-white py-2 px-2 text-lg flex my-1" : "cursor-pointer hover:bg-gray-100 dark:hover:bg-"+themeColor+"-900 my-1 rounded-lg dark:text-white py-2 px-2 text-lg flex"}>
                        <span className={activeTab == "general" ? "text-white h-10 w-10 p-2 bg-gray-200 dark:bg-transparent rounded-full" :"h-10 w-10 p-2 bg-gray-200 dark:bg-transparent dark:text-"+themeColor+"-500 rounded-full"}><ChipIcon /></span>
                        <span className="mt-1 mx-2">General</span>
                    </li>
                    <li onClick={() => setActiveTab("security_login")} className={activeTab == "security_login" ? "cursor-pointer hover:bg-gray-100 dark:bg-"+themeColor+"-500 bg-gray-100 dark:hover:bg-"+themeColor+"-700 rounded-lg dark:text-white my-1 py-2 px-2 text-lg flex" : "cursor-pointer dark:hover:bg-"+themeColor+"-900 my-1 hover:bg-gray-100 rounded-lg dark:text-white py-2 px-2 text-lg flex"}>
                    ...
                    <li onClick={() => setActiveTab("location")} className={activeTab == "location" ? "cursor-pointer hover:bg-gray-100 bg-gray-100 dark:bg-"+themeColor+"-500 dark:hover:bg-"+themeColor+"-700 rounded-lg dark:text-white py-2 px-2 text-lg flex my-1" : "cursor-pointer hover:bg-gray-100 dark:hover:bg-"+themeColor+"-900 my-1 rounded-lg dark:text-white py-2 px-2 text-lg flex"}>
                        <span className={activeTab == "location" ? "text-white h-10 w-10 p-2 bg-gray-200 dark:bg-transparent rounded-full" :"h-10 w-10 p-2 bg-gray-200 dark:bg-transparent dark:text-"+themeColor+"-500 rounded-full"}><LocationMarkerIcon /></span>
                        <span className="mt-1 mx-2">Location</span>
                    </li>
                    <li onClick={() => setActiveTab("live_shows")} className={activeTab == "live_shows" ? "cursor-pointer hover:bg-gray-100 bg-gray-100 dark:bg-"+themeColor+"-500 dark:hover:bg-"+themeColor+"-700 rounded-lg dark:text-white py-2 px-2 text-lg flex my-1" : "cursor-pointer hover:bg-gray-100 dark:hover:bg-"+themeColor+"-900 my-1 rounded-lg dark:text-white py-2 px-2 text-lg flex"}>
                    ...
                    <li onClick={() => setActiveTab("blocking")} className={activeTab == "blocking" ? "cursor-pointer hover:bg-gray-100 bg-gray-100 dark:bg-"+themeColor+"-500 dark:hover:bg-"+themeColor+"-700 rounded-lg dark:text-white py-2 px-2 text-lg flex my-1" : "cursor-pointer hover:bg-gray-100 dark:hover:bg-"+themeColor+"-900 my-1 rounded-lg dark:text-white py-2 px-2 text-lg flex"}>
                    ...
                    <hr className="my-2 border dark:border-gray-900"/>
                    <li onClick={() => setActiveTab("payments")} className={activeTab == "payments" ? "cursor-pointer hover:bg-gray-100 bg-gray-100 dark:bg-"+themeColor+"-500 dark:hover:bg-"+themeColor+"-700 rounded-lg dark:text-white py-2 px-2 text-lg flex my-1" : "cursor-pointer hover:bg-gray-100 dark:hover:bg-"+themeColor+"-900 my-1 rounded-lg dark:text-white py-2 px-2 text-lg flex"}>
